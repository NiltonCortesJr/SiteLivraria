      ...
      <form className="card">
        ...
        <div className="card-campos">
          ...
          <div className="alteraImagem">
            <label className="label" for="imagem">Url da Imagem: </label>
            <input className="inputs" type="text" name="name" />{" "}
            {/* AQUI VIRÁ A PROPS.URL */}
          </div>
          <div className="alteraTitulo">
            <label className="label" for="titulo">Título: </label>
            <input className="inputs" type="text" name="name" />{" "}
            {/* AQUI VIRÁ A PROPS.NOME */}
          </div>
          <div className="alteraAutora">
            <label className="label" for="autora">Autor(a): </label>
            <input className="inputs" type="text" name="name" />{" "}
            {/* AQUI VIRÁ A PROPS.URL */}
          </div>
          <div className="alteraPreco">
            <label className="label" for="preco">Preço: </label>
            <input className="inputs" type="text" name="name" />{" "}
            {/* AQUI VIRÁ A PROPS.URL */}
          </div>
